...
export function useGameLoop({
  ...
  useEffect(() => {
    ...
    const loop = () => {
      ...
      renderProjectiles(ctx, s.projectiles, frame);
      renderEnemies(ctx, s.enemies, frame);
      renderBow(ctx, cx, cy, mousePos.current.x, mousePos.current.y, s, frame);
